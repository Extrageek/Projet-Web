...
describe("computerAI should", () => {
    ...
    it("construct itself", () => {
        expect(() => { new ComputerAI(rinkInfo, meanFriction, Stone.ROTATION_DISPLACEMENT, Difficulty.HARD); })
            .to.not.throw(Error);
    });
});
...
describe("computerAI should", () => {
    ...
    beforeEach(() => {
        computerAI = new ComputerAI(rinkInfo, meanFriction, Stone.ROTATION_DISPLACEMENT, Difficulty.PERFECT);
