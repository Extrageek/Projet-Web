...
describe("BankLetterHandler should", () => {
    ...
    it("exchange letters correctly in case there are sufficiant letters in bank", () => {
        ...
        lettersToChange.push(new Letter(Alphabet.A, AlphabetPoint.letterA, AlphabetQuantity.letterA));
        lettersToChange.push(new Letter(Alphabet.B, AlphabetPoint.letterB, AlphabetQuantity.letterB));
        lettersToChange.push(new Letter(Alphabet.C, AlphabetPoint.letterC, AlphabetQuantity.letterC));
        lettersToChange.push(new Letter(Alphabet.D, AlphabetPoint.letterD, AlphabetQuantity.letterD));
        lettersToChange.push(new Letter(Alphabet.E, AlphabetPoint.letterE, AlphabetQuantity.letterE));
